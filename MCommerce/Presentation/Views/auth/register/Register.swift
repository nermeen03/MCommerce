    ...
    var body: some View {
            ...
            ScrollView{
                VStack(alignment: .leading){
                    ...
                    CustomButton(text: "Sign Up", textColor: .white, backgroundColor: .deepPurple ,verticalOffset: 0 , action:  {
                        viewModel.register()
                    }).padding(.top ,24)
                ...
                }.frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: .infinity, alignment: .topLeading).padding().navigationBarBackButtonHidden(true).alert(isPresented: $viewModel.showError) {
